...
Enter the app name"""
    ...
    back = backup.Backup(files=[
        ...
        backup.ConcreteFile("Library/Preferences/temp", "RootDomain", owner=33, group=33, contents=helper_contents,
                            inode=0),
        backup.Directory("",
        ...
        backup.ConcreteFile("",
                            ...
                            owner=501, group=501, contents=b""),  # Break the hard link
    ...
    try:
        ...
        if "Find My" in str(e):
            ...
            click.secho(f"Disable Find My from Settings (Settings -> [Your Name] -> Find My) and then try again.",
                        fg='red')
            sys.exit(1)
    ...
    click.secho(
        f"Make sure to install a proper persistence helper into the app you chose after installing TrollStore!\n",
        fg='green')
